...
API_ID = int(environ.get('API_ID', '24719696'))
API_HASH = environ.get('API_HASH', '862d5b32031f8a9b9a547aca40ef1640')
BOT_TOKEN = environ.get('BOT_TOKEN', '7735986238:AAHEiRn7lJluIM5jadhzfbNfhnwvOg9Of3A')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8047797327').split()]
USERNAME = environ.get('USERNAME', "https://t.me/anujmore96k") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002300728524'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/indiancinemahouse')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002435487917').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
